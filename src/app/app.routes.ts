...
export const routes: Routes = [
  ...
  { path: 'fish24/internal/news/comments', loadComponent: () => import('./features/fish24/internal/news/internal-news-comments.component').then(m => m.InternalNewsCommentsComponent), canActivate: [authGuard, newsManagementGuard] },
