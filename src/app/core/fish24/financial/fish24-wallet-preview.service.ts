...
const SEED_TRANSACTIONS: readonly Fish24WalletTransaction[] = [
  { id: '4006', employerId: '1002', operationId: 'top-up-22562', createdAt: '1405/06/19 09:25', amountRial: 500_000, balanceAfterRial: 18_000_000, direction: 'credit', origin: 'wallet-top-up', status: 'success', mobile: '09129876543', fullName: 'رضا کریمی', companyName: 'شرکت راهکار نوین', workplaceName: 'شرکت راهکار نوین', trackingCode: 'TRX-22562', userType: 'حقوقی', description: 'شارژ خودکار کیف پول', formalInvoiceId: 2, formalInvoiceNumber: '22562' },
